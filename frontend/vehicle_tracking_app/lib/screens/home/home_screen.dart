    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        ...
        if (user?.roleId == 1 || user?.roleName == 'admin') {
          // Usuario con rol 1 o admin - mostrar pantalla de administrador
          return const AdminHomeScreen();
        } else if (user?.roleId == 2 || user?.roleName == 'driver') {
          // Usuario con rol 2 o driver - mostrar pantalla de conductor
          return const DriverHomeScreen();
        } else {
          // Rol no reconocido o usuario sin rol - mostrar pantalla genérica
          return _buildGenericHomeScreen();
        }
      },
    );
  }

  Widget _buildGenericHomeScreen() {
          ...
          bottomNavigationBar: Padding(
            ...
            child: ConvexBottomBar(
              ...
              items: const [
                ...
                BottomBarItem(icon: Icons.location_on_rounded, label: 'Ubicación'),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        CircleAvatar(
                          radius: 50,
                          backgroundColor: themeProvider.getSecondaryColor(isDark),
                          child: Text(
                            user?.fullName != null 
                        ...
                        if (user?.roleName != null) ...[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: themeProvider.getSecondaryColor(isDark),
